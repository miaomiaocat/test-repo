...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/miaomiaocat/podTestLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'miaomiaocat' => 'wangyan@syswin.com' }
  s.source           = { :git => 'https://github.com/miaomiaocat/podTestLibrary.git', :tag => s.version.to_s }
